...
# 注册Dubbo服务消费者的URL(consumer://192.168.1.2/spring.guides.dubbo.service.DemoService?application=xxx&category=consumers&side=consumer, 当前主机: 192.168.1.2)
